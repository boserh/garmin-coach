...
**🟠 high** — лишається одноразова операційна частина OPS-02 **на Pi**: увімкнути
systemd-таймер та задати реальний off-SD `--rsync-dest` (захист від втрати річної
історії; це ops-дія на Pi, не код).
