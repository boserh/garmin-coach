...
| --- | --- | --- | --- |
| [OPS-01](OPS-01-garmin-auth-plan-b.md) | Garmin auth: підготувати і перевірити «план Б» (python-garminconnect) | M–L | зливається з PERF-05; поглинає адаптацію ST-06 |
