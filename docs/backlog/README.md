...
| [NF-02](NF-02-correlation-engine.md) | 🟢 low | Кореляційний движок — «що на тебе насправді діє» (спершу дешевий розвідпрогін) | L | 0.7 | розвідковий прогін перед розробкою (§4.4) |
...
| [NF-07](NF-07-quarterly-wrapped.md) | ⚪ lowest | Квартальний/річний огляд («Wrapped») — раз і в задоволення | S–M | 0.14 | EP-14 бажано |
...
| ID | Пріор. | Назва | Оцінка | Залежності |
| --- | --- | --- | --- | --- |
| [CODE-03](CODE-03-remove-legacy-paths.md) | 🟡 medium | Прибрати legacy: `WEB_TOKEN`, `GARTH_TOKEN_DIR` (`gconn` НЕ видаляти — OPS-01) | S | — |
| [CODE-02](CODE-02-cli-push-plan-reuse-plan-sync.md) | 🟢 low | CLI `push-plan` поверх `plan_sync` (залишок: відбір вікна) | S | — |
| [CODE-07](CODE-07-import-fit-series-refactor-tests.md) | 🟢 low | Розплутати `import_fit_series` + тести (cyclomatic 20, вкладеність 8, 0 тестів) | S–M | — (низький пріоритет) |
