...
🔴 highest / 🟠 high / 🟡 medium / 🟢 low / ⚪ lowest. Наступний логічний тікет —
**EP-12** (ввод болю + RPE-тренд в адаптацію, підсилює свіжий NF-04); «прибрати борг
перед розгоном» — **CODE-01**; стратегічно — **EP-08**. Frozen-тікети — ⚪.
...
| --- | --- | --- | --- | --- |
| [EP-12](EP-12-post-run-checkin.md) | 🔴 highest | Пост-тренувальний check-in (RPE + самопочуття) — MVP ✅, лишились фази 2–3 (RPE-тренд в адаптацію, статус план/факт) | M–L | — |
...
| ID | Пріор. | Назва | Оцінка | Залежності |
| --- | --- | --- | --- | --- |
| [CODE-01](CODE-01-split-analysis-service.md) | 🟠 high | Розбити `analysis/service.py` (**уже ~1600 рядків** — кожна фіча роздуває) на пакет; зробити до наступної великої фічі в `analysis` | M | до/разом з PERF-02, PERF-04b |
