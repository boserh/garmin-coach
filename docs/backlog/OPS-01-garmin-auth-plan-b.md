...
> **Виконано в [OPS-10](OPS-10-migrate-to-garminconnect.md)** (2026-07-26) — і не за
> фактом поломки, як планувалось тут, а проактивно, поки garth ще працював. Нижче —
> оригінальний план; що з нього виявилось точним, а що ні (формат токена, GET-only
> `connectapi`, MFA-міст без змін), розписано в ACʼях OPS-10.
