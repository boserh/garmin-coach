...
**❄️ Frozen (2026-07):** прив'язаний до відкриття `/register` чужим — заморожений разом з EP-06 тим самим garth-ризиком; аудит індексів (композитні `user_id+date`) можна зробити окремо і дешево (ANALYSIS.md §1.3).
